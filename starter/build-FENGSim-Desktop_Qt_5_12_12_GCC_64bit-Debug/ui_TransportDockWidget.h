...
"}"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/figure/transport_wind/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/prefix1/figure/transport_wind/cad.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/prefix1/figure/transport_wind/select.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/prefix1/figure/transport_wind/source.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/new/prefix1/figure/transport_wind/data.png"), QSize(), QIcon::Normal, QIcon::Off);
