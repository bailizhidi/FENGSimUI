...
public:
    ...
    void setupUi(QWidget *MeasureDockWidget)
    {
        ...
        frame = new QFrame(MeasureDockWidget);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/new/measure/figure/measure_wind/novision.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon9.addFile(QString::fromUtf8(":/new/measure/figure/measure_wind/vision.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/amwind/figure/am_wind/ok.png"), QSize(), QIcon::Normal, QIcon::Off);
